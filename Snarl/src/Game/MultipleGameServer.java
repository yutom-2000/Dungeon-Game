...
/**
 * This will allow for multiple games on the same levels
 */
public class MultipleGameServer {
  ...
  public static ArgumentParser createParser() {
    ...
    parser.addArgument("--games").type(Integer.class).setDefault(1);
    return parser;
  }
  ...
  public static void main(String[] args) throws IOException {
    ...
    int clients = 0, wait = 0, portNum = 0, adversaries = 0, numGames = 1;
    ...
    try {
      ...
      if (levels == null) {
          throw new IllegalArgumentException("Ensure that levels are not null");
      }
    //^loading levels and parsing args
